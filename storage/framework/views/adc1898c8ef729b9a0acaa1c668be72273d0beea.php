...
unset($__errorArgs, $__bag); ?>" id="nama" placeholder="Nama jenis" name="nama" value="<?php echo e(old('nama', $pdln->nama)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="jumlah_orang" placeholder="nomor surat" name="jumlah_orang" value="<?php echo e(old('jumlah_orang', $pdln->jumlah_orang)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="unit_kerja" placeholder="nomor surat" name="unit_kerja" value="<?php echo e(old('unit_kerja', $pdln->unit_kerja)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="jangka_waktu_awal" placeholder="jangka waktu Awal" name="jangka_waktu_awal" value="<?php echo e(old('jangka_waktu_awal', $pdln->jangka_waktu_awal)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="jangka_waktu_akhir" placeholder="Jangka Waktu Akhir" name="jangka_waktu_akhir" value="<?php echo e(old('jangka_waktu_akhir', $pdln->jangka_waktu_akhir)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            name="tujuan"
                            value="<?php echo e(old('tujuan', $pdln->tujuan)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            name="negara"
                            value="<?php echo e(old('negara', $pdln->negara)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            name="surat_uns"
                            value="<?php echo e(old('surat_uns', $pdln->surat_uns)); ?>">
                            <?php $__errorArgs = ['surat_uns'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            placeholder="catatan"
                            name="catatan_uns"
                            value="<?php echo e(old('catatan_uns', $pdln->catatan_uns)); ?>">
                            <?php $__errorArgs = ['catatan_uns'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            placeholder="nomor surat"
                            name="belmawa"
                            value="<?php echo e(old('belmawa', $pdln->belmawa)); ?>">
                            <?php $__errorArgs = ['belmawa'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            value="<?php echo e(old('catatan_belmawa', $pdln->catatan_belmawa)); ?>">
                            <?php $__errorArgs = ['catatan_belmawa'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="ktln_kemensetneg" placeholder="nomor surat kemensetneg" name="ktln_kemensetneg" value="<?php echo e(old('ktln_kemensetneg', $pdln->ktln_kemensetneg)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="catatan_setneg" placeholder="catatan" name="catatan_setneg" value="<?php echo e(old('catatan_setneg', $pdln->catatan_setneg)); ?>">
...
<?php echo $__env->make('dashboard/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (3)\dkpi-uns\resources\views/pdln/edit.blade.php ENDPATH**/ ?>