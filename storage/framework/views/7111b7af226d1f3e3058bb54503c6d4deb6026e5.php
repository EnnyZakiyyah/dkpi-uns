        ...
        <div class="container" data-aos="fade-up">
            ...
            <ul id="portfolio-flters" class="d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <!-- CV/PT -->
              <div class="col-lg-6 col-md-6 portfolio-item filter-mou">
                
                <div class="portfolio-img"><img src="<?php echo e(asset('storage/'. $header  ->gambar )); ?>" class="img-fluid" alt="" <?php echo e(asset('storage/'. $header->gambar )); ?> width="620" height="350"></div>
