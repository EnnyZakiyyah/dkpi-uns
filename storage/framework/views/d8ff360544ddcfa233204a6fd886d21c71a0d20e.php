            ...
            <table class="table align-items-center table-flush">
              ...
              <tbody class="list">
                ...
                <tr>
                  ...
                  <td>  <img src="<?php echo e(asset('storage/'. $header->gambar )); ?>" class="img-fluid mb-3 col-sm-5 d-block" alt="..."></td>
                  <td>
...
<?php echo $__env->make('dashboard/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dkpi-uns\resources\views/header/index.blade.php ENDPATH**/ ?>