        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <!-- body card -->
                    <div method="POST" action="/peringkat/<?php echo e($peringkat->id); ?>" enctype="multipart/form-data>
...
unset($__errorArgs, $__bag); ?>" id="judul" placeholder="judul peringkat" name="judul" value="<?php echo e(old('judul', $peringkat->judul)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="peringkat" placeholder="peringkat peringkat" name="peringkat" value="<?php echo e(old('peringkat', $peringkat->peringkat)); ?>">
                            <?php $__errorArgs = ['peringkat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('dashboard/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (3)\dkpi-uns\resources\views/peringkat/edit.blade.php ENDPATH**/ ?>