                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($date = empty(strtotime($pimpinan->jangka_waktu_awal)) ? $pimpinan->jangka_waktu_awal : Carbon\Carbon::parse(date('Y-m-d', strtotime($pimpinan->jangka_waktu_awal)))->isoFormat('D MMMM Y')); ?>

                                </td>
                                <td><?php echo e($date = empty(strtotime($pimpinan->jangka_waktu_akhir)) ? $pimpinan->jangka_waktu_akhir : Carbon\Carbon::parse(date('Y-m-d', strtotime($pimpinan->jangka_waktu_akhir)))->isoFormat('D MMMM Y')); ?>

                                </td>
                                <td><?php echo e($pimpinan->status); ?></td>
                                <td>
                                    <a href="/home/pdln/<?php echo e($pimpinan->id); ?>" class="badge bg-info"><span
                                            data-feather="eye">lihat</span></a>
                                    <?php if(Auth::check()): ?>
                                    <a href="/pdln/<?php echo e($pimpinan->id); ?>/edit" class="badge bg-warning"><span
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (3)\dkpi-uns\resources\views/home/pdln/pimpinan.blade.php ENDPATH**/ ?>