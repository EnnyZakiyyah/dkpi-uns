...
unset($__errorArgs, $__bag); ?>" id="pertanyaan" placeholder="pertanyaan" name="pertanyaan" value="<?php echo e(old('pertanyaan', $faq->pertanyaan)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="jawaban" placeholder="jawaban" name="jawaban" value="<?php echo e(old('jawaban', $faq->jawaban)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="link" placeholder="cth: /home/layanan" name="link" value="<?php echo e(old('link',$faq->link)); ?>">
...
<?php echo $__env->make('dashboard/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (3)\dkpi-uns\resources\views/faq/edit.blade.php ENDPATH**/ ?>