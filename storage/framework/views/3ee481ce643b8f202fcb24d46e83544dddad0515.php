        ...
        <div class="row">
            <div class="col">
                ...
                <?php endif; ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Judul Video : <?php echo e($gallery->judul); ?></h5>
...
<?php echo $__env->make('dashboard/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (3)\dkpi-uns\resources\views/gallery/show.blade.php ENDPATH**/ ?>