                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($date = empty(strtotime($mahasiswa->jangka_waktu_awal)) ? $mahasiswa->jangka_waktu_awal : Carbon\Carbon::parse(date('Y-m-d', strtotime($mahasiswa->jangka_waktu_awal)))->isoFormat('D MMMM Y')); ?>

                                </td>
                                <td><?php echo e($date = empty(strtotime($mahasiswa->jangka_waktu_akhir)) ? $mahasiswa->jangka_waktu_akhir : Carbon\Carbon::parse(date('Y-m-d', strtotime($mahasiswa->jangka_waktu_akhir)))->isoFormat('D MMMM Y')); ?>

                                </td>
                                <td><?php echo e($mahasiswa->status); ?></td>
                                <td>
                                    <a href="/home/pdln/<?php echo e($mahasiswa->id); ?>" class="badge bg-info"><span
                                            data-feather="eye">lihat</span></a>
                                    <?php if(Auth::check()): ?>
                                    <a href="/pdln/<?php echo e($mahasiswa->id); ?>/edit" class="badge bg-warning"><span
...
</section><!-- PDLN Mahasiswa Section -->

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (3)\dkpi-uns\resources\views/home/pdln/mahasiswa.blade.php ENDPATH**/ ?>