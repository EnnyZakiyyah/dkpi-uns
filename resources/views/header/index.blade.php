      ...
      <div class="col">
        <div class="card">
          ...
          <div class="table-responsive">
            <table class="table align-items-center table-flush">
              ...
              <tbody class="list">
                ...
                <tr>
                  <th scope="row">{{ $headers->firstItem() + $loop->index }}</th>
                  <td>{{ $header->nama }}</td>
                  <td>  <img src="{{asset('storage/'. $header->gambar )}}" class="img-fluid mb-3 col-sm-5 d-block" alt="..."></td>
                  <td>
                    <a href="/header/{{ $header->id }}" class="badge badge-info">Detail</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
          ...
          <div class="card-footer py-4">
            <nav aria-label="...">
              <a href="{{'/header/create'}}" class="btn btn-primary">Tambah Data</a>
