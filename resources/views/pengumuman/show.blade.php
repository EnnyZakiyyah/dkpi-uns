...
@section('title', 'Database pengumuman')
                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                {{-- <li class="breadcrumb-item"><a href="#"> {{ $pengumuman->instansi }}</a></li> --}}
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Nama instansi: {{ $pengumuman->judul}}</h5>
                            <h6 class="card-subtitle mb-2 text-muted">{{ $pengumuman->instansi}}</h6>
                            <p class="card-text">{{ $pengumuman->pengumuman }}</p>
                            <p class="card-text">{{ $pengumuman->link }}</p>
                            <p class="card-text">{{ $pengumuman->berlaku }}</p>
